  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        console.error(err);
        alert(
          `Failed to create product: ${err.response?.data?.message || err.message
          }`
        );
      } finally {
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <label
                  ...
                  className={`flex items-center gap-2 px-4 py-2 border-2 rounded-lg cursor-pointer transition-colors ${errors.image
